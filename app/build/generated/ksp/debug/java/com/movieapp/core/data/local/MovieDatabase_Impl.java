...
import com.movieapp.core.data.local.dao.FavoriteMovieDao_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `favorite_movies` (`id` INTEGER NOT NULL, `title` TEXT NOT NULL, `posterPath` TEXT, `overview` TEXT NOT NULL, `voteAverage` REAL NOT NULL, `releaseDate` TEXT NOT NULL, `genreIds` TEXT NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '803b3a22d5864ae997551baaeb226a17')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsFavoriteMovies.put("genreIds", new TableInfo.Column("genreIds", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoFavoriteMovies.equals(_existingFavoriteMovies)) {
          return new RoomOpenHelper.ValidationResult(false, "favorite_movies(com.movieapp.core.data.local.entity.FavoriteMovieEntity).\n"
                  + " Expected:\n" + _infoFavoriteMovies + "\n"
                  + " Found:\n" + _existingFavoriteMovies);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "803b3a22d5864ae997551baaeb226a17", "8a3d3c44b0cb10c3d4ed405919da0389");
